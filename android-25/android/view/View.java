...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource
{
     ...
     * @hide
     */
    @IntDef({SCROLLBARS_INSIDE_OVERLAY, SCROLLBARS_INSIDE_INSET, SCROLLBARS_OUTSIDE_OVERLAY,
     ...
     * @hide
     */
    @IntDef(flag = true, value = {FOCUSABLES_ALL, FOCUSABLES_TOUCH_MODE})
    @Retention(RetentionPolicy.SOURCE)
    ...
    static
    {
        ...
        SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED |
                StateSet.VIEW_STATE_SELECTED);

        FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED);
        FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED |
                StateSet.VIEW_STATE_FOCUSED);
        FOCUSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED);
        FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED);

        ENABLED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_ENABLED);
        ENABLED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED |
                StateSet.VIEW_STATE_ENABLED);
        ENABLED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_ENABLED);
        ENABLED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED | StateSet
                .VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_FOCUSED | StateSet
                .VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED);

        PRESSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_PRESSED);
        PRESSED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED |
                StateSet.VIEW_STATE_PRESSED);
        PRESSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_FOCUSED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_ENABLED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_ENABLED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_ENABLED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED | StateSet
                .VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_FOCUSED | StateSet
                .VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED |
                StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet
                .VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet
                .VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet
                .VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
    }

    /**
     * Accessibility event types that are dispatched for text population.
     */
    private static final int POPULATING_ACCESSIBILITY_EVENT_TYPES = AccessibilityEvent
            .TYPE_VIEW_CLICKED | AccessibilityEvent.TYPE_VIEW_LONG_CLICKED | AccessibilityEvent
            .TYPE_VIEW_SELECTED | AccessibilityEvent.TYPE_VIEW_FOCUSED | AccessibilityEvent
            .TYPE_WINDOW_STATE_CHANGED | AccessibilityEvent.TYPE_VIEW_HOVER_ENTER |
            AccessibilityEvent.TYPE_VIEW_HOVER_EXIT | AccessibilityEvent.TYPE_VIEW_TEXT_CHANGED |
            AccessibilityEvent.TYPE_VIEW_TEXT_SELECTION_CHANGED | AccessibilityEvent
     ...
     * @hide
     */
    @IntDef({LAYOUT_DIRECTION_LTR, LAYOUT_DIRECTION_RTL, LAYOUT_DIRECTION_INHERIT,
     ...
     * @hide
     */
    static final int PFLAG2_LAYOUT_DIRECTION_MASK = 0x00000003 <<
    ...
    /**
     * Mask for use with private flags indicating bits used for resolved horizontal layout
     * direction.
     *
     * @hide
     */
     ...
     * @hide
     */
    private static final int[] PFLAG2_TEXT_DIRECTION_FLAGS = {TEXT_DIRECTION_INHERIT <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_FIRST_STRONG <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_ANY_RTL <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_LTR <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_RTL <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_LOCALE <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_FIRST_STRONG_LTR <<
            PFLAG2_TEXT_DIRECTION_MASK_SHIFT, TEXT_DIRECTION_FIRST_STRONG_RTL <<
     ...
     * @hide
     */
    static final int PFLAG2_TEXT_DIRECTION_RESOLVED_DEFAULT = TEXT_DIRECTION_RESOLVED_DEFAULT <<
            PFLAG2_TEXT_DIRECTION_RESOLVED_MASK_SHIFT;

    /**
     * @hide
     */
    @IntDef({TEXT_ALIGNMENT_INHERIT, TEXT_ALIGNMENT_GRAVITY, TEXT_ALIGNMENT_CENTER,
            TEXT_ALIGNMENT_TEXT_START, TEXT_ALIGNMENT_TEXT_END, TEXT_ALIGNMENT_VIEW_START,
     ...
     * @hide
     */
    private static final int[] PFLAG2_TEXT_ALIGNMENT_FLAGS = {TEXT_ALIGNMENT_INHERIT <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT, TEXT_ALIGNMENT_GRAVITY <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT, TEXT_ALIGNMENT_TEXT_START <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT, TEXT_ALIGNMENT_TEXT_END <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT, TEXT_ALIGNMENT_CENTER <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT, TEXT_ALIGNMENT_VIEW_START <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT, TEXT_ALIGNMENT_VIEW_END <<
     ...
     * @hide
     */
    static final int PFLAG2_TEXT_ALIGNMENT_RESOLVED = 0x00000008 <<
            PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT;
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(flag = true, value = {SCROLL_INDICATOR_TOP, SCROLL_INDICATOR_BOTTOM,
            SCROLL_INDICATOR_LEFT, SCROLL_INDICATOR_RIGHT, SCROLL_INDICATOR_START,
     ...
     */
    public static final int SCROLL_INDICATOR_TOP = PFLAG3_SCROLL_INDICATOR_TOP >>
     ...
     * @see #getScrollIndicators()
     */
    public static final int SCROLL_INDICATOR_BOTTOM = PFLAG3_SCROLL_INDICATOR_BOTTOM >>
            SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT;
     ...
     * @see #getScrollIndicators()
     */
    public static final int SCROLL_INDICATOR_LEFT = PFLAG3_SCROLL_INDICATOR_LEFT >>
            SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT;
     ...
     * @see #getScrollIndicators()
     */
    public static final int SCROLL_INDICATOR_RIGHT = PFLAG3_SCROLL_INDICATOR_RIGHT >>
            SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT;
     ...
     * @see #getScrollIndicators()
     */
    public static final int SCROLL_INDICATOR_START = PFLAG3_SCROLL_INDICATOR_START >>
            SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT;
     ...
     * @see #getScrollIndicators()
     */
    public static final int SCROLL_INDICATOR_END = PFLAG3_SCROLL_INDICATOR_END >>
            SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT;
    ...
    /**
     * @hide Makes navigation bar transparent (but not the status bar).
     */
    public static final int NAVIGATION_BAR_TRANSPARENT = 0x00008000;

    /**
     * @hide Makes status bar transparent (but not the navigation bar).
     */
    public static final int STATUS_BAR_TRANSPARENT = 0x0000008;

    /**
     * @hide Makes both status bar and navigation bar transparent.
     */
     ...
     * @hide
     */
    @IntDef(flag = true, value = {FIND_VIEWS_WITH_TEXT, FIND_VIEWS_WITH_CONTENT_DESCRIPTION})
    @Retention(RetentionPolicy.SOURCE)
     ...
     * {@hide}
     */
    @ViewDebug.ExportedProperty(flagMapping = {@ViewDebug.FlagToString(mask = PFLAG_FORCE_LAYOUT,
            equals = PFLAG_FORCE_LAYOUT, name = "FORCE_LAYOUT"), @ViewDebug.FlagToString(mask =
            PFLAG_LAYOUT_REQUIRED, equals = PFLAG_LAYOUT_REQUIRED, name = "LAYOUT_REQUIRED"),
            @ViewDebug.FlagToString(mask = PFLAG_DRAWING_CACHE_VALID, equals =
                    PFLAG_DRAWING_CACHE_VALID, name = "DRAWING_CACHE_INVALID", outputIf = false),
            @ViewDebug.FlagToString(mask = PFLAG_DRAWN, equals = PFLAG_DRAWN, name = "DRAWN",
                    outputIf = true), @ViewDebug.FlagToString(mask = PFLAG_DRAWN, equals =
            PFLAG_DRAWN, name = "NOT_DRAWN", outputIf = false), @ViewDebug.FlagToString(mask =
            PFLAG_DIRTY_MASK, equals = PFLAG_DIRTY_OPAQUE, name = "DIRTY_OPAQUE"), @ViewDebug
            .FlagToString(mask = PFLAG_DIRTY_MASK, equals = PFLAG_DIRTY, name = "DIRTY")},
     ...
     * @hide
     */
    @ViewDebug.ExportedProperty(flagMapping = {@ViewDebug.FlagToString(mask =
            SYSTEM_UI_FLAG_LOW_PROFILE, equals = SYSTEM_UI_FLAG_LOW_PROFILE, name =
            "SYSTEM_UI_FLAG_LOW_PROFILE", outputIf = true), @ViewDebug.FlagToString(mask =
            SYSTEM_UI_FLAG_HIDE_NAVIGATION, equals = SYSTEM_UI_FLAG_HIDE_NAVIGATION, name =
            "SYSTEM_UI_FLAG_HIDE_NAVIGATION", outputIf = true), @ViewDebug.FlagToString(mask =
            PUBLIC_STATUS_BAR_VISIBILITY_MASK, equals = SYSTEM_UI_FLAG_VISIBLE, name =
            "SYSTEM_UI_FLAG_VISIBLE", outputIf = true)}, formatToHexString = true)
     ...
     */
    public static final int DRAG_FLAG_GLOBAL_PERSISTABLE_URI_PERMISSION = Intent
     ...
     */
    public static final int DRAG_FLAG_GLOBAL_PREFIX_URI_PERMISSION = Intent
    ...
    @ViewDebug.ExportedProperty(category = "drawing", mapping = {@ViewDebug.IntToString(from =
            LAYER_TYPE_NONE, to = "NONE"), @ViewDebug.IntToString(from = LAYER_TYPE_SOFTWARE, to
            = "SOFTWARE"), @ViewDebug.IntToString(from = LAYER_TYPE_HARDWARE, to = "HARDWARE")})
    ...
    protected final InputEventConsistencyVerifier mInputEventConsistencyVerifier =
            InputEventConsistencyVerifier.isInstrumentationEnabled() ? new
                    InputEventConsistencyVerifier(this, 0) : null;
    ...
    public View(Context context)
    {
        ...
        mPrivateFlags2 = (LAYOUT_DIRECTION_DEFAULT << PFLAG2_LAYOUT_DIRECTION_MASK_SHIFT) |
                ...
                (PFLAG2_TEXT_DIRECTION_RESOLVED_DEFAULT) | (TEXT_ALIGNMENT_DEFAULT <<
                PFLAG2_TEXT_ALIGNMENT_MASK_SHIFT) | (PFLAG2_TEXT_ALIGNMENT_RESOLVED_DEFAULT) |
    ...
    public View(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R
                .styleable.View, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < N; i++)
        {
            ...
            switch (attr)
            {
                ...
                case R.styleable.View_stateListAnimator:
                    setStateListAnimator(AnimatorInflater.loadStateListAnimator(context, a
                ...
                case R.styleable.View_backgroundTint:
                    ...
                    mBackgroundTint.mTintList = a.getColorStateList(R.styleable
                            .View_backgroundTint);
                ...
                case R.styleable.View_backgroundTintMode:
                    ...
                    mBackgroundTint.mTintMode = Drawable.parseTintMode(a.getInt(R.styleable
                            .View_backgroundTintMode, -1), null);
                ...
                case R.styleable.View_foregroundInsidePadding:
                    if (targetSdkVersion >= VERSION_CODES.M || this instanceof FrameLayout)
                    {
                        ...
                        mForegroundInfo.mInsidePadding = a.getBoolean(attr, mForegroundInfo
                                .mInsidePadding);
                    }
                    break;
                case R.styleable.View_scrollIndicators:
                    final int scrollIndicators = (a.getInt(attr, 0) <<
        ...
        if (isRtlCompatibilityMode())
        {
            ...
            // left / right padding are used if defined (meaning here nothing to do). If they are
            // not
            // defined and start / end padding are defined (e.g. in Frameworks resources), then
            // we use
            // start / end and resolve them as left / right (layout direction is not taken into
            // account).
    ...
    private static class DeclaredOnClickListener implements OnClickListener
    {
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String name)
        {
            ...
            final String idText = id == NO_ID ? "" : " with id '" + mHostView.getContext()
    ...
    protected void initializeFadingEdgeInternal(TypedArray a)
    {
        ...
        mScrollCache.fadingEdgeLength = a.getDimensionPixelSize(R.styleable
                .View_fadingEdgeLength, ViewConfiguration.get(mContext).getScaledFadingEdgeLength
                ());
    }
    ...
    protected void initializeScrollbarsInternal(TypedArray a)
    {
        ...
        scrollabilityCache.scrollBarFadeDuration = a.getInt(R.styleable
                .View_scrollbarFadeDuration, ViewConfiguration.getScrollBarFadeDuration());
        scrollabilityCache.scrollBarDefaultDelayBeforeFade = a.getInt(R.styleable
                .View_scrollbarDefaultDelayBeforeFade, ViewConfiguration.getScrollDefaultDelay());


        scrollabilityCache.scrollBarSize = a.getDimensionPixelSize(com.android.internal.R
                .styleable.View_scrollbarSize, ViewConfiguration.get(mContext)
    ...
    private boolean isOnVerticalScrollbarThumb(float x, float y)
    {
        ...
        if (isVerticalScrollBarEnabled() && !isVerticalScrollBarHidden())
        {
            ...
            if (x >= bounds.left && x <= bounds.right && y >= thumbTop && y <= thumbTop +
                    thumbLength)
            {
                return true;
            }
    ...
    private boolean isOnHorizontalScrollbarThumb(float x, float y)
    {
        ...
        if (isHorizontalScrollBarEnabled())
        {
            ...
            if (x >= thumbLeft && x <= thumbLeft + thumbLength && y >= bounds.top && y <= bounds
                    .bottom)
            {
                return true;
            }
    ...
    {
        return mScrollCache != null && mScrollCache.mScrollBarDraggingState != ScrollabilityCache
                .NOT_DRAGGING;
    }
    ...
    public void addOnAttachStateChangeListener(OnAttachStateChangeListener listener)
    {
        ...
        {
            li.mOnAttachStateChangeListeners = new
            ...
            listener, Handler handler)
    {
        if (mAttachInfo != null)
        {
            if (mAttachInfo.mHardwareRenderer != null)
            {
                ...
                FrameMetricsObserver fmo = new FrameMetricsObserver(window, handler.getLooper(),
                        listener);
    ...
    public void removeFrameMetricsListener(Window.OnFrameMetricsAvailableListener listener)
    {
        ...
        if (fmo == null)
        {
            throw new IllegalArgumentException("attempt to remove OnFrameMetricsAvailableListener" +
    ...
    {
        if (event.isFromSource(InputDevice.SOURCE_MOUSE) && (event.getButtonState() & MotionEvent
                .BUTTON_SECONDARY) != 0)
        {
    ...
    public boolean requestRectangleOnScreen(Rect rectangle, boolean immediate)
    {
        ...
        while (parent != null)
        {
            rectangle.set((int) position.left, (int) position.top, (int) position.right, (int)
                    position.bottom);
     ...
     *                              {@link #FOCUS_RIGHT}, {@link #FOCUS_FORWARD}, or
     *                              {@link #FOCUS_BACKWARD}.
     *                              It may not always apply, in which case use the default.
     * @param previouslyFocusedRect The rectangle, in this view's coordinate
     *                              system, of the previously focused view.  If applicable, this
     *                              will be
     *                              passed in as finer grained information about where the focus
     *                              is coming
     *                              from (in addition to direction).  Will be <code>null</code>
     *                              otherwise.
     */
    @CallSuper
    protected void onFocusChanged(boolean gainFocus, @FocusDirection int direction, @Nullable
            Rect previouslyFocusedRect)
    {
        ...
        {
            notifyViewAccessibilityStateChangedIfNeeded(AccessibilityEvent
    ...
    public void onInitializeAccessibilityEventInternal(AccessibilityEvent event)
    {
        ...
        switch (event.getEventType())
        {
            ...
            {
                ArrayList<View> focusablesTempList = (mAttachInfo != null) ? mAttachInfo
                        .mTempArrayList : new ArrayList<View>();
    ...
    public void getBoundsOnScreen(Rect outRect, boolean clipToParent)
    {
        ...
        outRect.set(Math.round(position.left), Math.round(position.top), Math.round(position
                .right), Math.round(position.bottom));
    }
    ...
    private void populateVirtualStructure(ViewStructure structure, AccessibilityNodeProvider
            provider, AccessibilityNodeInfo info)
    {
        ...
        {
            structure.setText(info.getText(), info.getTextSelectionStart(), info
                    .getTextSelectionEnd());
        }
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info)
    {
        ...
        if (mID != View.NO_ID)
        {
            ...
            if ((mAttachInfo.mAccessibilityFetchFlags & AccessibilityNodeInfo
                    .FLAG_REPORT_VIEW_IDS) != 0 && Resources.resourceHasPackage(mID))
            {
                try
                {
        ...
        if (text != null && text.length() > 0)
        {
            ...
            info.setMovementGranularities(AccessibilityNodeInfo.MOVEMENT_GRANULARITY_CHARACTER |
                    AccessibilityNodeInfo.MOVEMENT_GRANULARITY_WORD | AccessibilityNodeInfo
            ...
            else
            {
                ...
                if (childCount > 1)
                {
                    ...
                    else
                    {
                        ...
                        final int childDrawIndex = ((childIndex >= 0) && customOrder) ?
                        ...
                        if (childDrawIndex != 0)
                        {
                            ...
                            {
                                final int otherDrawIndex = (customOrder ? parentGroup
                                        .getChildDrawingOrder(childCount, i) : i);
                                if (otherDrawIndex < childDrawIndex)
                                {
                                    drawingOrderInParent += numViewsForAccessibility(parentGroup
                                            .getChildAt(i));
                                }
                            }
                        }
    ...
    protected boolean isVisibleToUser(Rect boundInView)
    {
        if (mAttachInfo != null)
        {
            ...
            while (current instanceof View)
            {
                ...
                if (view.getAlpha() <= 0 || view.getTransitionAlpha() <= 0 || view.getVisibility
                        () != VISIBLE)
                {
                    return false;
                }
    ...
    private boolean fitSystemWindowsInt(Rect insets)
    {
        if ((mViewFlags & FITS_SYSTEM_WINDOWS) == FITS_SYSTEM_WINDOWS)
        {
            ...
            internalSetPadding(localInsets.left, localInsets.top, localInsets.right, localInsets
                    .bottom);
            return res;
        }
        return false;
    ...
    protected boolean computeFitSystemWindows(Rect inoutInsets, Rect outLocalInsets)
    {
        if ((mViewFlags & OPTIONAL_FITS_SYSTEM_WINDOWS) == 0 || mAttachInfo == null || (
                (mAttachInfo.mSystemUiVisibility & SYSTEM_UI_LAYOUT_FLAGS) == 0 && !mAttachInfo
                        .mOverscanRequested))
        {
     ...
     * to those under it.
     *
     * @param in             Insets currently being processed by this View, likely received as a
     *                       parameter
    ...
    @ViewDebug.ExportedProperty(mapping = {@ViewDebug.IntToString(from = VISIBLE, to = "VISIBLE")
            , @ViewDebug.IntToString(from = INVISIBLE, to = "INVISIBLE"), @ViewDebug.IntToString
            (from = GONE, to = "GONE")})
    @Visibility
     ...
     * @hide
     */
    @ViewDebug.ExportedProperty(category = "layout", mapping = {@ViewDebug.IntToString(from =
            LAYOUT_DIRECTION_LTR, to = "LTR"), @ViewDebug.IntToString(from =
            LAYOUT_DIRECTION_RTL, to = "RTL"), @ViewDebug.IntToString(from =
            LAYOUT_DIRECTION_INHERIT, to = "INHERIT"), @ViewDebug.IntToString(from =
            LAYOUT_DIRECTION_LOCALE, to = "LOCALE")})
    @LayoutDir
     ...
     *                        LAYOUT_DIRECTION_INHERIT. The resolution
     *                        proceeds up the parent chain of the view to get the value. If there
     *                        is no parent, then it
     ...
     */
    @ViewDebug.ExportedProperty(category = "layout", mapping = {@ViewDebug.IntToString(from =
            LAYOUT_DIRECTION_LTR, to = "RESOLVED_DIRECTION_LTR"), @ViewDebug.IntToString(from =
            LAYOUT_DIRECTION_RTL, to = "RESOLVED_DIRECTION_RTL")})
    @ResolvedLayoutDir
    ...
    public void setHasTransientState(boolean hasTransientState)
    {
        ...
        if (mTransientStateCount < 0)
        {
            ...
            Log.e(VIEW_LOG_TAG, "hasTransientState decremented below 0: " + "unmatched pair of " +
                    "setHasTransientState calls");
        }
        else if ((hasTransientState && mTransientStateCount == 1) || (!hasTransientState &&
                mTransientStateCount == 0))
        {
            // update flag if we've just incremented up from 0 or decremented down to 0
            mPrivateFlags2 = (mPrivateFlags2 & ~PFLAG2_HAS_TRANSIENT_STATE) | (hasTransientState
                    ? PFLAG2_HAS_TRANSIENT_STATE : 0);
            if (mParent != null)
            {
                try
                {
                ...
                {
                    Log.e(VIEW_LOG_TAG, mParent.getClass().getSimpleName() + " does not fully " +
                            "implement ViewParent", e);
                }
            }
        }
    }
     ...
     * @see #setContentDescription(CharSequence)
     */
    public void findViewsWithText(ArrayList<View> outViews, CharSequence searched, @FindViewFlags
            int flags)
    {
        ...
        else if ((flags & FIND_VIEWS_WITH_CONTENT_DESCRIPTION) != 0 && (searched != null &&
                searched.length() > 0) && (mContentDescription != null && mContentDescription
                .length() > 0))
        {
    ...
    public void addTouchables(ArrayList<View> views)
    {
        ...
        if (((viewFlags & CLICKABLE) == CLICKABLE || (viewFlags & LONG_CLICKABLE) ==
                LONG_CLICKABLE || (viewFlags & CONTEXT_CLICKABLE) == CONTEXT_CLICKABLE) &&
     ...
     *               AccessibilityNodeInfo#ACTION_ACCESSIBILITY_FOCUS to specify that focus is
     *               moving within
     *               the window.
     */
     ...
     */
    @ViewDebug.ExportedProperty(category = "accessibility", mapping = {@ViewDebug.IntToString
            (from = IMPORTANT_FOR_ACCESSIBILITY_AUTO, to = "auto"), @ViewDebug.IntToString(from =
            IMPORTANT_FOR_ACCESSIBILITY_YES, to = "yes"), @ViewDebug.IntToString(from =
            IMPORTANT_FOR_ACCESSIBILITY_NO, to = "no"), @ViewDebug.IntToString(from =
            IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS, to = "noHideDescendants")})
    ...
    public void setImportantForAccessibility(int mode)
    {
        ...
        if (mode != oldMode)
        {
            ...
            final boolean maySkipNotify = oldMode == IMPORTANT_FOR_ACCESSIBILITY_AUTO || mode ==
    ...
    public boolean isImportantForAccessibility()
    {
        final int mode = (mPrivateFlags2 & PFLAG2_IMPORTANT_FOR_ACCESSIBILITY_MASK) >>
                PFLAG2_IMPORTANT_FOR_ACCESSIBILITY_SHIFT;
        if (mode == IMPORTANT_FOR_ACCESSIBILITY_NO || mode ==
                IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS)
        {
            return false;
        }
    ...
    public boolean includeForAccessibility()
    {
        if (mAttachInfo != null)
        {
            return (mAttachInfo.mAccessibilityFetchFlags & AccessibilityNodeInfo
                    .FLAG_INCLUDE_NOT_IMPORTANT_VIEWS) != 0 || isImportantForAccessibility();
        }
        return false;
    }
    ...
    private boolean hasListenersForAccessibility()
    {
        ...
        return mTouchDelegate != null || info.mOnKeyListener != null || info.mOnTouchListener !=
                null || info.mOnGenericMotionListener != null || info.mOnHoverListener != null ||
    ...
    public void notifyViewAccessibilityStateChangedIfNeeded(int changeType)
    {
        ...
        {
            mSendViewStateChangedAccessibilityEvent = new SendViewStateChangedAccessibilityEvent();
        }
    ...
    public void notifySubtreeAccessibilityStateChangedIfNeeded()
    {
        ...
        if ((mPrivateFlags2 & PFLAG2_SUBTREE_ACCESSIBILITY_STATE_CHANGED) == 0)
        {
            ...
            if (mParent != null)
            {
                try
                {
                    mParent.notifySubtreeAccessibilityStateChanged(this, this, AccessibilityEvent
    ...
    {
        if (isNestedScrollingEnabled() && (action == AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD
                || action == AccessibilityNodeInfo.ACTION_SCROLL_FORWARD || action == R.id
                .accessibilityActionScrollUp || action == R.id.accessibilityActionScrollLeft ||
                action == R.id.accessibilityActionScrollDown || action == R.id
        ...
        switch (action)
        {
            ...
            case AccessibilityNodeInfo.ACTION_NEXT_AT_MOVEMENT_GRANULARITY:
            {
                if (arguments != null)
                {
                    ...
                    final boolean extendSelection = arguments.getBoolean(AccessibilityNodeInfo
            ...
            case AccessibilityNodeInfo.ACTION_SET_SELECTION:
            {
                ...
                final int start = (arguments != null) ? arguments.getInt(AccessibilityNodeInfo
                        .ACTION_ARGUMENT_SELECTION_START_INT, -1) : -1;
                final int end = (arguments != null) ? arguments.getInt(AccessibilityNodeInfo
                        .ACTION_ARGUMENT_SELECTION_END_INT, -1) : -1;
                // Only cursor position can be specified (selection length == 0)
                if ((getAccessibilitySelectionStart() != start || getAccessibilitySelectionEnd()
                        != end) && (start == end))
                {
    ...
    private void sendViewTextTraversedAtGranularityEvent(int action, int granularity, int
    ...
    public TextSegmentIterator getIteratorForGranularity(int granularity)
    {
        switch (granularity)
        {
            ...
            case AccessibilityNodeInfo.MOVEMENT_GRANULARITY_WORD:
            {
                ...
                if (text != null && text.length() > 0)
                {
                    WordTextSegmentIterator iterator = WordTextSegmentIterator.getInstance
            ...
            case AccessibilityNodeInfo.MOVEMENT_GRANULARITY_PARAGRAPH:
            {
                ...
                if (text != null && text.length() > 0)
                {
                    ParagraphTextSegmentIterator iterator = ParagraphTextSegmentIterator
                            .getInstance();
                    iterator.initialize(text.toString());
                    return iterator;
                }
    ...
    public boolean onFilterTouchEventForSecurity(MotionEvent event)
    {
        ...
        if ((mViewFlags & FILTER_TOUCHES_WHEN_OBSCURED) != 0 && (event.getFlags() & MotionEvent
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event)
    {
        ...
        if ((source & InputDevice.SOURCE_CLASS_POINTER) != 0)
        {
            ...
            if (action == MotionEvent.ACTION_HOVER_ENTER || action == MotionEvent
                    .ACTION_HOVER_MOVE || action == MotionEvent.ACTION_HOVER_EXIT)
            {
    ...
    private boolean dispatchGenericMotionEventInternal(MotionEvent event)
    {
        //noinspection SimplifiableIfStatement
        ListenerInfo li = mListenerInfo;
        if (li != null && li.mOnGenericMotionListener != null && (mViewFlags & ENABLED_MASK) ==
                ENABLED && li.mOnGenericMotionListener.onGenericMotion(this, event))
        {
            return true;
        }
        ...
        switch (event.getActionMasked())
        {
            case MotionEvent.ACTION_BUTTON_PRESS:
                if (isContextClickable() && !mInContextButtonPress && !mHasPerformedLongPress &&
                        (actionButton == MotionEvent.BUTTON_STYLUS_PRIMARY || actionButton ==
     ...
     */
    protected void dispatchVisibilityChanged(@NonNull View changedView, @Visibility int visibility)
    {
    ...
    void needGlobalAttributesUpdate(boolean force)
    {
        ...
        {
            if (force || ai.mKeepScreenOn || (ai.mSystemUiVisibility != 0) || ai
                    .mHasSystemUiListeners)
            {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if (KeyEvent.isConfirmKey(keyCode))
        {
            ...
            if (((mViewFlags & CLICKABLE) == CLICKABLE || (mViewFlags & LONG_CLICKABLE) ==
                    LONG_CLICKABLE) && (event.getRepeatCount() == 0))
            {
    ...
    public boolean onHoverEvent(MotionEvent event)
    {
        ...
        {
            if ((action == MotionEvent.ACTION_HOVER_ENTER || action == MotionEvent
                    .ACTION_HOVER_MOVE) && !hasHoveredChild() && pointInView(event.getX(), event
                    .getY()))
            {
        ...
        {
            if (action == MotionEvent.ACTION_HOVER_EXIT || (action == MotionEvent.ACTION_MOVE &&
        ...
        if ((action == MotionEvent.ACTION_HOVER_ENTER || action == MotionEvent.ACTION_HOVER_MOVE)
                && event.isFromSource(InputDevice.SOURCE_MOUSE) && isOnScrollbar(event.getX(),
                event.getY()))
        {
            awakenScrollBars();
        }
    ...
    protected boolean handleScrollBarDragging(MotionEvent event)
    {
        ...
        final int action = event.getAction();
        if ((mScrollCache.mScrollBarDraggingState == ScrollabilityCache.NOT_DRAGGING && action !=
                MotionEvent.ACTION_DOWN) || !event.isFromSource(InputDevice.SOURCE_MOUSE) ||
        ...
        switch (action)
        {
            case MotionEvent.ACTION_MOVE:
                ...
                if (mScrollCache.mScrollBarDraggingState == ScrollabilityCache
                        .DRAGGING_VERTICAL_SCROLL_BAR)
                {
                    final Rect bounds = mScrollCache.mScrollBarBounds;
                    getVerticalScrollBarBounds(bounds);
                    final int range = computeVerticalScrollRange();
                    ...
                    final int thumbLength = ScrollBarUtils.getThumbLength(bounds.height(), bounds
                            .width(), extent, range);
                    final int thumbOffset = ScrollBarUtils.getThumbOffset(bounds.height(),
                            thumbLength, extent, range, offset);

                    final float diff = y - mScrollCache.mScrollBarDraggingPos;
                    final float maxThumbOffset = bounds.height() - thumbLength;
                    final float newThumbOffset = Math.min(Math.max(thumbOffset + diff, 0.0f),
                            maxThumbOffset);
                    final int height = getHeight();
                    if (Math.round(newThumbOffset) != thumbOffset && maxThumbOffset > 0 && height
                            > 0 && extent > 0)
                    {
                        final int newY = Math.round((range - extent) / ((float) extent / height)
                ...
                if (mScrollCache.mScrollBarDraggingState == ScrollabilityCache
                        .DRAGGING_HORIZONTAL_SCROLL_BAR)
                {
                    final Rect bounds = mScrollCache.mScrollBarBounds;
                    getHorizontalScrollBarBounds(bounds);
                    final int range = computeHorizontalScrollRange();
                    ...
                    final int thumbLength = ScrollBarUtils.getThumbLength(bounds.width(), bounds
                            .height(), extent, range);
                    final int thumbOffset = ScrollBarUtils.getThumbOffset(bounds.width(),
                            thumbLength, extent, range, offset);
                    ...
                    if (Math.round(newThumbOffset) != thumbOffset && maxThumbOffset > 0 && width
                            > 0 && extent > 0)
                    {
                        final int newX = Math.round((range - extent) / ((float) extent / width) *
                                (newThumbOffset / maxThumbOffset));
                        if (newX != getScrollX())
                        {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                {
                    mScrollCache.mScrollBarDraggingState = ScrollabilityCache
                            .DRAGGING_VERTICAL_SCROLL_BAR;
                    mScrollCache.mScrollBarDraggingPos = y;
                    return true;
                }
            ...
            switch (action)
            {
                case MotionEvent.ACTION_UP:
                    ...
                    if ((mPrivateFlags & PFLAG_PRESSED) != 0 || prepressed)
                    {
                        ...
                        if (prepressed)
                        {
                            postDelayed(mUnsetPressedState, ViewConfiguration
    ...
    {
        final int action = event.getAction();
        if (mAttachInfo == null || action != MotionEvent.ACTION_DOWN && action != MotionEvent
                .ACTION_MOVE || !event.isTouchEvent())
        {
            return;
        }
    ...
    void setFlags(int flags, int mask)
    {
        ...
        if (((changed & FOCUSABLE_MASK) != 0) && ((privateFlags & PFLAG_HAS_BOUNDS) != 0))
        {
            ...
            else if (((old & FOCUSABLE_MASK) == NOT_FOCUSABLE) && ((privateFlags & PFLAG_FOCUSED)
                    == 0))
            {
                /*
        ...
        if ((changed & VISIBILITY_MASK) != 0)
        {
            ...
            if (mAttachInfo != null)
            {
                ...
                if (mParent != null && getWindowVisibility() == VISIBLE && ((!(mParent instanceof
                        ViewGroup)) || ((ViewGroup) mParent).isShown()))
                {
        ...
        if ((changed & DRAW_MASK) != 0)
        {
            ...
            {
                if (mBackground != null || (mForegroundInfo != null && mForegroundInfo.mDrawable
                        != null))
                {
        ...
        {
            if ((changed & FOCUSABLE_MASK) != 0 || (changed & VISIBILITY_MASK) != 0 || (changed &
                    CLICKABLE) != 0 || (changed & LONG_CLICKABLE) != 0 || (changed &
                    CONTEXT_CLICKABLE) != 0)
            {
    ...
    public interface OnLayoutChangeListener
    {
         ...
         */
        void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int
     ...
     */
    @ViewDebug.ExportedProperty(category = "measurement", flagMapping = {@ViewDebug.FlagToString
            (mask = MEASURED_STATE_MASK, equals = MEASURED_STATE_TOO_SMALL, name =
    ...
    {
        return (mMeasuredWidth & MEASURED_STATE_MASK) | ((mMeasuredHeight >>
    ...
    {
        return (mPrivateFlags3 & PFLAG3_HAS_OVERLAPPING_RENDERING_FORCED) != 0 ? (mPrivateFlags3
                & PFLAG3_OVERLAPPING_RENDERING_FORCED_VALUE) != 0 : hasOverlappingRendering();
    }
    ...
    /**
     * Sets the right position of this view relative to its parent. This method is meant to be
     * called
     * by the layout system and should not generally be called otherwise, because the property
     * may be changed at any time by the layout.
     *
     ...
     * Circular clips from a {@link ViewAnimationUtils#createCircularReveal(View, int, int,
     * float, float)
    ...
    {
        return localX >= -slop && localY >= -slop && localX < ((mRight - mLeft) + slop) && localY
                < ((mBottom - mTop) + slop);
    }
    ...
    {
        return mScrollCache != null && awakenScrollBars(mScrollCache
                .scrollBarDefaultDelayBeforeFade, true);
    }
    ...
    {
        return mScrollCache != null && awakenScrollBars(mScrollCache
                .scrollBarDefaultDelayBeforeFade * 4, true);
    }
    ...
    public void invalidate(Rect dirty)
    {
        ...
        invalidateInternal(dirty.left - scrollX, dirty.top - scrollY, dirty.right - scrollX,
                dirty.bottom - scrollY, true, false);
    }
    ...
    void invalidateInternal(int l, int t, int r, int b, boolean invalidateCache, boolean
            fullInvalidate)
    {
        if (mGhostView != null)
        {
        ...
        if ((mPrivateFlags & (PFLAG_DRAWN | PFLAG_HAS_BOUNDS)) == (PFLAG_DRAWN |
                PFLAG_HAS_BOUNDS) || (invalidateCache && (mPrivateFlags &
     ...
     * @param forceRedraw      Mark the view as DRAWN to force the invalidation to propagate, if
     *                         display
     *                         list properties are not being used in this view
     */
    void invalidateViewProperty(boolean invalidateParent, boolean forceRedraw)
    {
        if (!isHardwareAccelerated() || !mRenderNode.isValid() || (mPrivateFlags &
                PFLAG_DRAW_ANIMATION) != 0)
        {
            if (invalidateParent)
            {
                invalidateParentCaches();
    ...
    void transformRect(final Rect rect)
    {
        if (!getMatrix().isIdentity())
        {
            ...
            rect.set((int) Math.floor(boundingRect.left), (int) Math.floor(boundingRect.top),
    ...
    protected void computeOpaqueFlags()
    {
        ...
        if (((flags & SCROLLBARS_VERTICAL) == 0 && (flags & SCROLLBARS_HORIZONTAL) == 0) ||
                (flags & SCROLLBARS_STYLE_MASK) == SCROLLBARS_INSIDE_OVERLAY || (flags &
                SCROLLBARS_STYLE_MASK) == SCROLLBARS_OUTSIDE_OVERLAY)
        {
    ...
    public void postOnAnimation(Runnable action)
    {
        ...
        if (attachInfo != null)
        {
            attachInfo.mViewRootImpl.mChoreographer.postCallback(Choreographer
                    .CALLBACK_ANIMATION, action, null);
        }
        else
        {
    ...
    public void postOnAnimationDelayed(Runnable action, long delayMillis)
    {
        ...
        if (attachInfo != null)
        {
            attachInfo.mViewRootImpl.mChoreographer.postCallbackDelayed(Choreographer
                    .CALLBACK_ANIMATION, action, null, delayMillis);
        }
        else
        {
            // Postpone the runnable until we know
    ...
    public boolean removeCallbacks(Runnable action)
    {
        if (action != null)
        {
            ...
            if (attachInfo != null)
            {
                ...
                attachInfo.mViewRootImpl.mChoreographer.removeCallbacks(Choreographer
                        .CALLBACK_ANIMATION, action, null);
            }
    ...
    private void postSendViewScrolledAccessibilityEventCallback()
    {
        ...
        if (!mSendViewScrolledAccessibilityEvent.mIsPending)
        {
            ...
            postDelayed(mSendViewScrolledAccessibilityEvent, ViewConfiguration
    ...
    {
        return mScrollCache == null ? ViewConfiguration.getScrollDefaultDelay() : mScrollCache
    ...
    {
        return mScrollCache == null ? ViewConfiguration.getScrollBarFadeDuration() : mScrollCache
     ...
     * @see #SCROLLBARS_OUTSIDE_INSET
     */
    @ViewDebug.ExportedProperty(mapping = {@ViewDebug.IntToString(from =
            SCROLLBARS_INSIDE_OVERLAY, to = "INSIDE_OVERLAY"), @ViewDebug.IntToString(from =
            SCROLLBARS_INSIDE_INSET, to = "INSIDE_INSET"), @ViewDebug.IntToString(from =
            SCROLLBARS_OUTSIDE_OVERLAY, to = "OUTSIDE_OVERLAY"), @ViewDebug.IntToString(from =
            SCROLLBARS_OUTSIDE_INSET, to = "OUTSIDE_INSET")})
    @ScrollBarStyle
    ...
    protected final void onDrawScrollBars(Canvas canvas)
    {
        ...
        if (cache != null)
        {
            ...
            if (state == ScrollabilityCache.FADING)
            {
                ...
                if (cache.scrollBarInterpolator.timeToValues(values) == Interpolator.Result
                        .FREEZE_END)
                {
            ...
            if (mRoundScrollbarRenderer != null)
            {
                if (drawVerticalScrollBar)
                {
                    ...
                    getVerticalScrollBarBounds(bounds);
                    mRoundScrollbarRenderer.drawRoundScrollbars(canvas, (float) cache.scrollBar
                            .getAlpha() / 255f, bounds);
                    if (invalidate)
                    {
                        invalidate();
                    }
            ...
            else if (drawVerticalScrollBar || drawHorizontalScrollBar)
            {
                ...
                if (drawHorizontalScrollBar)
                {
                    ...
                    final Rect bounds = cache.mScrollBarBounds;
                    getHorizontalScrollBarBounds(bounds);
                    onDrawHorizontalScrollBar(canvas, scrollBar, bounds.left, bounds.top, bounds
                            .right, bounds.bottom);
                    if (invalidate)
                    {
                        invalidate(bounds);
                ...
                if (drawVerticalScrollBar)
                {
                    ...
                    final Rect bounds = cache.mScrollBarBounds;
                    getVerticalScrollBarBounds(bounds);
                    onDrawVerticalScrollBar(canvas, scrollBar, bounds.left, bounds.top, bounds
                            .right, bounds.bottom);
                    if (invalidate)
                    {
                        invalidate(bounds);
     ...
     * @see android.widget.ScrollBarDrawable
     */
    protected void onDrawHorizontalScrollBar(Canvas canvas, Drawable scrollBar, int l, int t, int
            r, int b)
    {
     ...
     * @see android.widget.ScrollBarDrawable
     */
    protected void onDrawVerticalScrollBar(Canvas canvas, Drawable scrollBar, int l, int t, int
            r, int b)
    {
        scrollBar.setBounds(l, t, r, b);
        scrollBar.draw(canvas);
    ...
    void assignParent(ViewParent parent)
    {
        ...
        {
            throw new RuntimeException("view " + this + " being added, but" + " it already has a " +
                    "parent");
        }
    }
     ...
     * been changed.
     * <p>
     * Subclasses need to override this method to take care of cached information that depends on
     * the
    ...
    {
        return (mPrivateFlags2 & PFLAG2_LAYOUT_DIRECTION_RESOLVED) ==
    ...
    void dispatchAttachedToWindow(AttachInfo info, int visibility)
    {
        ...
        ListenerInfo li = mListenerInfo;
        final CopyOnWriteArrayList<OnAttachStateChangeListener> listeners = li != null ? li
    ...
    void dispatchCancelPendingInputEvents()
    {
        ...
        {
            throw new SuperNotCalledException("View " + getClass().getSimpleName() + " did not " +
                    "call through to super.onCancelPendingInputEvents()");
        }
    }
    ...
    protected void dispatchSaveInstanceState(SparseArray<Parcelable> container)
    {
        if (mID != NO_ID && (mViewFlags & SAVE_DISABLED_MASK) == 0)
        {
            ...
            {
                throw new IllegalStateException("Derived class did not call super" +
                        ".onSaveInstanceState()");
            }
            if (state != null)
            {
    ...
    protected void onRestoreInstanceState(Parcelable state)
    {
        ...
        if (state != null && !(state instanceof AbsSavedState))
        {
            throw new IllegalArgumentException("Wrong state class, expecting View State but " +
                    ...
                    + "This view's id is " + ViewDebug.resolveId(mContext, getId()) + ". Make " +
    ...
    {
        Log.d("View", indent + this + "             DIRTY(" + (mPrivateFlags & View
                .PFLAG_DIRTY_MASK) + ") DRAWN(" + (mPrivateFlags & PFLAG_DRAWN) + ")" + " " +
    ...
    public RenderNode updateDisplayListIfDirty()
    {
        ...
        if ((mPrivateFlags & PFLAG_DRAWING_CACHE_VALID) == 0 || !renderNode.isValid() ||
    ...
    {
        if ((mPrivateFlags & PFLAG_DRAWING_CACHE_VALID) == 0 || (autoScale ? mDrawingCache ==
                null : mUnscaledDrawingCache == null))
        {
            if (Trace.isTagEnabled(Trace.TRACE_TAG_VIEW))
            {
                Trace.traceBegin(Trace.TRACE_TAG_VIEW, "buildDrawingCache/SW Layer for " +
    ...
    private void buildDrawingCacheImpl(boolean autoScale)
    {
        ...
        mPrivateFlags |= PFLAG_DRAWN;
        if (mAttachInfo == null || !mAttachInfo.mHardwareAccelerated || mLayerType !=
                LAYER_TYPE_NONE)
        {
            mPrivateFlags |= PFLAG_DRAWING_CACHE_VALID;
        }
    ...
    public Bitmap createSnapshot(Bitmap.Config quality, int backgroundColor, boolean skipChildren)
    {
        ...
        Bitmap bitmap = Bitmap.createBitmap(mResources.getDisplayMetrics(), width > 0 ? width :
                1, height > 0 ? height : 1, quality);
        if (bitmap == null)
        {
     ...
     */
    private boolean applyLegacyAnimation(ViewGroup parent, long drawingTime, Animation a, boolean
            scalingRequired)
    {
        ...
        if (more)
        {
            ...
            else
            {
                ...
                parent.invalidate(left, top, left + (int) (region.width() + .5f), top + (int)
                        (region.height() + .5f));
            }
        }
        return more;
    ...
    void setDisplayListProperties(RenderNode renderNode)
    {
        if (renderNode != null)
        {
            ...
            renderNode.setClipToBounds(mParent instanceof ViewGroup && ((ViewGroup) mParent)
                    .getClipChildren());

            float alpha = 1;
            if (mParent instanceof ViewGroup && (((ViewGroup) mParent).mGroupFlags & ViewGroup
    ...
    boolean draw(Canvas canvas, ViewGroup parent, long drawingTime)
    {
         ...
         */
        boolean drawingWithRenderNode = mAttachInfo != null && mAttachInfo.mHardwareAccelerated
        ...
        else
        {
            ...
            if (!drawingWithRenderNode && (parentFlags & ViewGroup
                    .FLAG_SUPPORT_STATIC_TRANSFORMATIONS) != 0)
            {
                final Transformation t = parent.getChildTransformation();
        ...
        if (!concatMatrix && (parentFlags & (ViewGroup.FLAG_SUPPORT_STATIC_TRANSFORMATIONS |
                ViewGroup.FLAG_CLIP_CHILDREN)) == ViewGroup.FLAG_CLIP_CHILDREN && canvas
        ...
        if (transformToApply != null || alpha < 1 || !hasIdentityMatrix() || (mPrivateFlags3 &
                PFLAG3_VIEW_IS_ANIMATING_ALPHA) != 0)
        {
    ...
    private void drawBackground(Canvas canvas)
    {
        ...
        if (canvas.isHardwareAccelerated() && mAttachInfo != null && mAttachInfo
    ...
    {
        Insets parentInsets = mParent instanceof View ? ((View) mParent).getOpticalInsets() :
                Insets.NONE;
        Insets childInsets = getOpticalInsets();
        return setFrame(left + parentInsets.left - childInsets.left, top + parentInsets.top -
                childInsets.top, right + parentInsets.left + childInsets.right, bottom +
                parentInsets.top + childInsets.bottom);
    }
    ...
    protected boolean setFrame(int left, int top, int right, int bottom)
    {
        ...
        if (DBG)
        {
            Log.d("View", this + " View.setFrame(" + left + "," + top + "," + right + "," +
                    bottom + ")");
        }
    ...
    public void scheduleDrawable(@NonNull Drawable who, @NonNull Runnable what, long when)
    {
        if (verifyDrawable(who) && what != null)
        {
            ...
            if (mAttachInfo != null)
            {
                mAttachInfo.mViewRootImpl.mChoreographer.postCallbackDelayed(Choreographer
                        .CALLBACK_ANIMATION, what, who, Choreographer.subtractFrameDelay(delay));
            }
            else
            {
                // Postpone the runnable until we know
    ...
    public void unscheduleDrawable(@NonNull Drawable who, @NonNull Runnable what)
    {
        if (verifyDrawable(who) && what != null)
        {
            if (mAttachInfo != null)
            {
                mAttachInfo.mViewRootImpl.mChoreographer.removeCallbacks(Choreographer
                        .CALLBACK_ANIMATION, what, who);
            }
    ...
    protected void resolveDrawables()
    {
        ...
        if (!isLayoutDirectionResolved() && getRawLayoutDirection() == View
                .LAYOUT_DIRECTION_INHERIT)
        {
            return;
        }

        final int layoutDirection = isLayoutDirectionResolved() ? getLayoutDirection() :
    ...
    protected void drawableStateChanged()
    {
        ...
        if (mScrollCache != null)
        {
            ...
            {
                changed |= scrollBar.setState(state) && mScrollCache.state != ScrollabilityCache
                        .OFF;
            }
        }
    ...
    {
        if ((mViewFlags & DUPLICATE_PARENT_STATE) == DUPLICATE_PARENT_STATE && mParent instanceof
                View)
        {
        ...
        if (mAttachInfo != null && mAttachInfo.mHardwareAccelerationRequested && ThreadedRenderer
                .isAvailable())
        {
        ...
        if (false)
        {
            ...
            Log.i("View", toString() + " pressed=" + ((privateFlags & PFLAG_PRESSED) != 0) + " " +
                    "en=" + ((mViewFlags & ENABLED_MASK) == ENABLED) + " fo=" + hasFocus() + " " +
                    "sl=" + ((privateFlags & PFLAG_SELECTED) != 0) + " wf=" + hasWindowFocus() +
     ...
     *                        {@link #onCreateDrawableState(int)}, which will be modified to also
     *                        hold your
    ...
    public void setBackgroundDrawable(Drawable background)
    {
        ...
        if (background != null)
        {
            ...
            if (background.getPadding(padding))
            {
                ...
                switch (background.getLayoutDirection())
                {
                    case LAYOUT_DIRECTION_RTL:
                        ...
                        internalSetPadding(padding.right, padding.top, padding.left, padding
                                .bottom);
                        break;
                    case LAYOUT_DIRECTION_LTR:
                    default:
                        mUserPaddingLeftInitial = padding.left;
                        mUserPaddingRightInitial = padding.right;
                        internalSetPadding(padding.left, padding.top, padding.right, padding
                                .bottom);
                }
            ...
            if (mBackground == null || mBackground.getMinimumHeight() != background
                    .getMinimumHeight() || mBackground.getMinimumWidth() != background
                    .getMinimumWidth())
            {
                requestLayout = true;
            }
        ...
        else
        {
            ...
            mBackground = null;
            if ((mViewFlags & WILL_NOT_DRAW) != 0 && (mForegroundInfo == null || mForegroundInfo
                    .mDrawable == null))
            {
                mPrivateFlags |= PFLAG_SKIP_DRAW;
            }
    ...
    {
        return mForegroundInfo != null && mForegroundInfo.mTintInfo != null ? mForegroundInfo
    ...
    {
        if (mForegroundInfo != null && mForegroundInfo.mDrawable != null && mForegroundInfo
                .mTintInfo != null)
        {
    ...
    public void onDrawForeground(Canvas canvas)
    {
        ...
        if (foreground != null)
        {
            if (mForegroundInfo.mBoundsChanged)
            {
                ...
                {
                    selfBounds.set(getPaddingLeft(), getPaddingTop(), getWidth() -
     ...
     * @hide
     */
    @ViewDebug.ExportedProperty(category = "layout", indexMapping = {@ViewDebug.IntToString(from
            = 0, to = "x"), @ViewDebug.IntToString(from = 1, to = "y")})
    ...
    public final void measure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        final boolean specChanged = widthMeasureSpec != mOldWidthMeasureSpec || heightMeasureSpec
                != mOldHeightMeasureSpec;
        final boolean isSpecExactly = MeasureSpec.getMode(widthMeasureSpec) == MeasureSpec
                .EXACTLY && MeasureSpec.getMode(heightMeasureSpec) == MeasureSpec.EXACTLY;
        final boolean matchesSpecSize = getMeasuredWidth() == MeasureSpec.getSize
                (widthMeasureSpec) && getMeasuredHeight() == MeasureSpec.getSize(heightMeasureSpec);
        final boolean needsLayout = specChanged && (sAlwaysRemeasureExactly || !isSpecExactly ||
                !matchesSpecSize);
        ...
        if (forceLayout || needsLayout)
        {
            ...
            {
                throw new IllegalStateException("View with id " + getId() + ": " + getClass()
                        .getName() + "#onMeasure() did not set the" + " measured dimension by " +
        ...
        mMeasureCache.put(key, ((long) mMeasuredWidth) << 32 | (long) mMeasuredHeight &
    ...
    public boolean gatherTransparentRegion(Region region)
    {
        ...
        if (region != null && attachInfo != null)
        {
            ...
            if ((pflags & PFLAG_SKIP_DRAW) == 0)
            {
                ...
                region.op(location[0] - shadowOffset, location[1] - shadowOffset, location[0] +
                        mRight - mLeft + shadowOffset, location[1] + mBottom - mTop +
                        (shadowOffset * 3), Region.Op.DIFFERENCE);
            }
            else
            {
     ...
     * {@link android.graphics.Canvas} object, then it calls
     * {@link #onDrawShadow(Canvas) onDrawShadow()}
    ...
    public static class DragShadowBuilder
    {
         ...
         * </p>
         *
         * @param outShadowSize       A {@link android.graphics.Point} containing the width and
         *                            height
         *                            of the shadow image. Your application must set
         *                            {@link android.graphics.Point#x} to the
         *                            desired width and must set {@link android.graphics.Point#y}
         *                            to the desired height of the
         *                            image.
         * @param outShadowTouchPoint A {@link android.graphics.Point} for the position within the
         *                            shadow image that should be underneath the touch point
         *                            during the drag and drop
         *                            operation. Your application must set
         *                            {@link android.graphics.Point#x} to the
         *                            X coordinate and {@link android.graphics.Point#y} to the Y
     ...
     */
    public final boolean startDrag(ClipData data, DragShadowBuilder shadowBuilder, Object
            myLocalState, int flags)
    {
     ...
     *                      drop operation. When dispatching drag events to views in the same
     *                      activity this object
     *                      will be available through
     *                      {@link android.view.DragEvent#getLocalState()}. Views in other
     *                      activities will not have access to this data
     *                      ({@link android.view.DragEvent#getLocalState()}
     *                      will return null).
     *                      <p>
     *                      myLocalState is a lightweight mechanism for the sending information
     *                      from the dragged View
     *                      to the target Views. For example, it can contain flags that
     *                      differentiate between a
     *                      a copy operation and a move operation.
     *                      </p>
     * @param flags         Flags that control the drag and drop operation. This can be set to 0
     *                      for no
     ...
     */
    public final boolean startDragAndDrop(ClipData data, DragShadowBuilder shadowBuilder, Object
            myLocalState, int flags)
    {
        ...
        try
        {
            mAttachInfo.mDragToken = mAttachInfo.mSession.prepareDrag(mAttachInfo.mWindow, flags,
                    shadowSize.x, shadowSize.y, mAttachInfo.mDragSurface);
            if (ViewDebug.DEBUG_DRAG)
                Log.d(VIEW_LOG_TAG, "prepareDrag returned token=" + mAttachInfo.mDragToken + " " +
            ...
            if (mAttachInfo.mDragToken != null)
            {
                ...
                okay = mAttachInfo.mSession.performDrag(mAttachInfo.mWindow, mAttachInfo
                        .mDragToken, root.getLastTouchSource(), shadowSize.x, shadowSize.y,
     ...
     *              The {@link android.view.DragEvent#getAction()} method returns an action type
     *              constant defined
    ...
    public boolean dispatchDragEvent(DragEvent event)
    {
        ...
        if (event.mAction == DragEvent.ACTION_DRAG_LOCATION || event.mAction == DragEvent
                .ACTION_DROP)
        {
            ...
            isTouchEvent)
    {
        ...
        final boolean canScrollHorizontal = computeHorizontalScrollRange() >
                computeHorizontalScrollExtent();
        final boolean canScrollVertical = computeVerticalScrollRange() >
    ...
    {
        if (overScrollMode != OVER_SCROLL_ALWAYS && overScrollMode !=
                OVER_SCROLL_IF_CONTENT_SCROLLS && overScrollMode != OVER_SCROLL_NEVER)
        {
     ...
     *
     * @param dxConsumed     Horizontal distance in pixels consumed by this view during this
     *                       scroll step
     * @param dyConsumed     Vertical distance in pixels consumed by this view during this scroll
     *                       step
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int
            dyUnconsumed, @Nullable @Size(2) int[] offsetInWindow)
    {
        if (isNestedScrollingEnabled() && mNestedScrollingParent != null)
        {
            if (dxConsumed != 0 || dyConsumed != 0 || dxUnconsumed != 0 || dyUnconsumed != 0)
            {
                ...
                mNestedScrollingParent.onNestedScroll(this, dxConsumed, dyConsumed, dxUnconsumed,
                        dyUnconsumed);
     ...
     * @param consumed       Output. If not null, consumed[0] will contain the consumed component
     *                       of dx
     ...
     * @see #dispatchNestedScroll(int, int, int, int, int[])
     */
    public boolean dispatchNestedPreScroll(int dx, int dy, @Nullable @Size(2) int[] consumed,
                                           @Nullable @Size(2) int[] offsetInWindow)
    {
        if (isNestedScrollingEnabled() && mNestedScrollingParent != null)
        {
            if (dx != 0 || dy != 0)
    ...
    protected float getVerticalScrollFactor()
    {
        if (mVerticalScrollFactor == 0)
        {
            ...
            if (!mContext.getTheme().resolveAttribute(com.android.internal.R.attr
                    .listPreferredItemHeight, outValue, true))
            {
     ...
     * @hide
     */
    @ViewDebug.ExportedProperty(category = "text", mapping = {@ViewDebug.IntToString(from =
            TEXT_DIRECTION_INHERIT, to = "INHERIT"), @ViewDebug.IntToString(from =
            TEXT_DIRECTION_FIRST_STRONG, to = "FIRST_STRONG"), @ViewDebug.IntToString(from =
            TEXT_DIRECTION_ANY_RTL, to = "ANY_RTL"), @ViewDebug.IntToString(from =
            TEXT_DIRECTION_LTR, to = "LTR"), @ViewDebug.IntToString(from = TEXT_DIRECTION_RTL, to
            = "RTL"), @ViewDebug.IntToString(from = TEXT_DIRECTION_LOCALE, to = "LOCALE"),
            @ViewDebug.IntToString(from = TEXT_DIRECTION_FIRST_STRONG_LTR, to =
                    "FIRST_STRONG_LTR"), @ViewDebug.IntToString(from =
            TEXT_DIRECTION_FIRST_STRONG_RTL, to = "FIRST_STRONG_RTL")})
     ...
     *                      {@link #TEXT_DIRECTION_FIRST_STRONG_RTL},
     *                      <p>
     *                      Resolution will be done if the value is set to TEXT_DIRECTION_INHERIT
     *                      . The resolution
     *                      proceeds up the parent chain of the view to get the value. If there
     *                      is no parent, then it will
                ...
                case TEXT_DIRECTION_INHERIT:
                    ...
                    switch (parentResolvedDirection)
                    {
                        ...
                        case TEXT_DIRECTION_FIRST_STRONG_RTL:
                            mPrivateFlags2 |= (parentResolvedDirection <<
                                    PFLAG2_TEXT_DIRECTION_RESOLVED_MASK_SHIFT);
                            break;
                        default:
     ...
     */
    @ViewDebug.ExportedProperty(category = "text", mapping = {@ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_INHERIT, to = "INHERIT"), @ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_GRAVITY, to = "GRAVITY"), @ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_TEXT_START, to = "TEXT_START"), @ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_TEXT_END, to = "TEXT_END"), @ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_CENTER, to = "CENTER"), @ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_VIEW_START, to = "VIEW_START"), @ViewDebug.IntToString(from =
            TEXT_ALIGNMENT_VIEW_END, to = "VIEW_END")})
    @TextAlignment
                ...
                case TEXT_ALIGNMENT_INHERIT:
                    ...
                    switch (parentResolvedTextAlignment)
                    {
                        ...
                        case TEXT_ALIGNMENT_VIEW_END:
                            ...
                            // text alignment
                            mPrivateFlags2 |= (parentResolvedTextAlignment <<
                                    PFLAG2_TEXT_ALIGNMENT_RESOLVED_MASK_SHIFT);
                            break;
                        default:
     ...
     */
    public static final Property<View, Float> TRANSLATION_Z = new FloatProperty<View>
            ("translationZ")
    {
        @Override
        public void setValue(View object, float value)
    ...
    public static class MeasureSpec
    {
         ...
         */
        public static int makeMeasureSpec(@IntRange(from = 0, to = (1 << MeasureSpec.MODE_SHIFT)
                - 1) int size, @MeasureSpecMode int mode)
        {
    ...
    private final class CheckForLongPress implements Runnable
    {
        ...
        public void run()
        {
            if (isPressed() && (mParent != null) && mOriginalWindowAttachCount ==
                    mWindowAttachCount)
            {
     ...
     *
     * @see View#setOnSystemUiVisibilityChangeListener(android.view.View
    ...
    public static class BaseSavedState extends AbsSavedState
    {
        ...
        public static final Parcelable.Creator<BaseSavedState> CREATOR = new Parcelable
                .ClassLoaderCreator<BaseSavedState>()
        {
            @Override
    ...
    final static class AttachInfo
    {
        ...
        static class InvalidateInfo
        {
            ...
            private static final SynchronizedPool<InvalidateInfo> sPool = new
                    SynchronizedPool<InvalidateInfo>(POOL_LIMIT);
         ...
         */
        final ViewTreeObserver.InternalInsetsInfo mGivenInternalInsets = new ViewTreeObserver
                .InternalInsetsInfo();
         ...
         */
        AttachInfo(IWindowSession session, IWindow window, Display display, ViewRootImpl
                viewRootImpl, Handler handler, Callbacks effectPlayer)
        {
            mSession = session;
            mWindow = window;
    ...
    private static class ScrollabilityCache implements Runnable
    {
        ...
        public void setFadeColor(int color)
        {
            if (color != mLastColor)
            {
                ...
                if (color != 0)
                {
                    shader = new LinearGradient(0, 0, 0, 1, color | 0xFF000000, color &
    ...
    private boolean shouldDrawRoundScrollbar()
    {
        ...
        return mAttachInfo.mTmpLocation[0] == insets.getStableInsetLeft() && mAttachInfo.mTmpLocation[1] == insets.getStableInsetTop();
    }
}
