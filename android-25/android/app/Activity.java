 ...
 * color="#800000"><strong>Pre-{@link android.os.Build.VERSION_CODES#HONEYCOMB}</strong></font></td>
 ...
 * border="0">{@link android.app.Activity#onDestroy onDestroy()}</td>
 ...
 * or finished.
 */
public class Activity extends ContextThemeWrapper implements LayoutInflater.Factory2, Window
        .Callback, KeyEvent.Callback, OnCreateContextMenuListener, ComponentCallbacks2, Window
        .OnWindowDismissedCallback, WindowControllerCallback
{
    ...
    private static final String KEYBOARD_SHORTCUTS_RECEIVER_CLASS_NAME = "com.android.systemui" +
            ".statusbar.KeyboardShortcutsReceiver";
    ...
    // set by the thread after the constructor and before onCreate(Bundle savedInstanceState) is
    // called.
    ...
    private ActivityManager.TaskDescription mTaskDescription = new ActivityManager
            .TaskDescription();
     ...
     */
    final void performRestoreInstanceState(Bundle savedInstanceState, PersistableBundle
            persistentState)
    {
    ...
    public boolean isVoiceInteractionRoot()
    {
        try
        {
            return mVoiceInteractor != null && ActivityManagerNative.getDefault()
                    .isRootVoiceInteraction(mToken);
        }
    ...
    @Override
    public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> data, Menu menu, int
            deviceId)
    {
        if (menu == null)
        {
        ...
        for (int i = 0; i < menuSize; ++i)
        {
            ...
            if (title != null && alphaShortcut != MIN_VALUE)
            {
                ...
                group.addItem(new KeyboardShortcutInfo(title, alphaShortcut, KeyEvent
                        .META_CTRL_ON));
            }
        }
        if (group != null)
     ...
     * @hide
     */
    @IntDef({DEFAULT_KEYS_DISABLE, DEFAULT_KEYS_DIALER, DEFAULT_KEYS_SHORTCUT,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            Window w = getWindow();
            if (w.hasFeature(Window.FEATURE_OPTIONS_PANEL) && w.performPanelShortcut(Window
                    .FEATURE_OPTIONS_PANEL, keyCode, event, Menu.FLAG_ALWAYS_PERFORM_CLOSE))
            {
                return true;
            }
            return false;
    ...
    public boolean dispatchKeyEvent(KeyEvent event)
    {
        ...
        else if (event.isCtrlPressed() && event.getUnicodeChar(event.getMetaState() & ~KeyEvent
                .META_CTRL_MASK) == '<')
        {
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event)
    {
        ...
        boolean isFullScreen = (params.width == LayoutParams.MATCH_PARENT) && (params.height ==
    ...
    {
        if (mWindow.hasFeature(Window.FEATURE_OPTIONS_PANEL) && (mActionBar == null ||
     ...
     * Stack</a>
     * from the developer guide and
     * <a href="{@docRoot}design/patterns/navigation.html">Navigation</a>
    ...
    {
        return new IllegalArgumentException("no dialog with id " + id + " was ever " + "shown via" +
                " Activity#showDialog");
    }
     ...
     *                           web-based) search instead.
     * @see android.app.SearchManager
     * @see #onSearchRequested
     */
    public void startSearch(@Nullable String initialQuery, boolean selectInitialQuery, @Nullable
    ...
    protected void onApplyThemeResource(Resources.Theme theme, @StyleRes int resid, boolean first)
    {
        ...
        TypedArray a = theme.obtainStyledAttributes(com.android.internal.R.styleable
                .ActivityTaskDescription);
        if (mTaskDescription.getPrimaryColor() == 0)
        {
            int colorPrimary = a.getColor(com.android.internal.R.styleable
        ...
        {
            int colorBackground = a.getColor(com.android.internal.R.styleable
                    .ActivityTaskDescription_colorBackground, 0);
    ...
    private Bundle transferSpringboardActivityOptions(Bundle options)
    {
        if (options == null && (mWindow != null && !mWindow.isActive()))
        {
            ...
            if (activityOptions != null && activityOptions.getAnimationType() == ActivityOptions
     ...
     * @hide Implement to provide correct calling token.
     */
    public void startActivityForResultAsUser(Intent intent, int requestCode, @Nullable Bundle
            options, UserHandle user)
    {
        if (mParent != null)
        {
        ...
        Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread
                .getApplicationThread(), mToken, this, intent, requestCode, options, user);
        if (ar != null)
        {
            mMainThread.sendActivityResult(mToken, mEmbeddedID, requestCode, ar.getResultCode(),
                    ar.getResultData());
    ...
    public void startActivityAsUser(Intent intent, Bundle options, UserHandle user)
    {
        ...
        options = transferSpringboardActivityOptions(options);
        Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread
                .getApplicationThread(), mToken, this, intent, -1, options, user);
        if (ar != null)
        {
            mMainThread.sendActivityResult(mToken, mEmbeddedID, -1, ar.getResultCode(), ar
                    .getResultData());
        }
        cancelInputsAndStartExitTransition(options);
    }
     ...
     *                             caller it is doing the start is, is actually allowed to start
     *                             the target activity.
     *                             If you set this to true, you must set an explicit component in
     *                             the Intent and do any
            ...
            ignoreTargetSecurity, int userId)
    {
        ...
        options = transferSpringboardActivityOptions(options);
        Instrumentation.ActivityResult ar = mInstrumentation.execStartActivityAsCaller(this,
                mMainThread.getApplicationThread(), mToken, this, intent, -1, options,
     ...
     */
    public void startIntentSenderForResult(IntentSender intent, int requestCode, @Nullable Intent
            fillInIntent, int flagsMask, int flagsValues, int extraFlags) throws IntentSender
            .SendIntentException
    {
     ...
     */
    public void startIntentSenderForResult(IntentSender intent, int requestCode, @Nullable Intent
            fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws
            IntentSender.SendIntentException
    {
        ...
        {
            mParent.startIntentSenderFromChild(this, intent, requestCode, fillInIntent,
    ...
    private void startIntentSenderForResultInner(IntentSender intent, String who, int
            requestCode, Intent fillInIntent, int flagsMask, int flagsValues, Bundle options)
            throws IntentSender.SendIntentException
    {
        try
        {
            ...
            int result = ActivityManagerNative.getDefault().startActivityIntentSender(mMainThread
                    .getApplicationThread(), intent, fillInIntent, resolvedType, mToken, who,
     ...
     * @param extraFlags   Always set to 0.
     */
    public void startIntentSender(IntentSender intent, @Nullable Intent fillInIntent, int
            flagsMask, int flagsValues, int extraFlags) throws IntentSender.SendIntentException
    {
     ...
     */
    public void startIntentSender(IntentSender intent, @Nullable Intent fillInIntent, int
            flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender
            .SendIntentException
    {
        if (options != null)
        {
     ...
     * @see #startActivityForResult
     */
    public boolean startActivityIfNeeded(@RequiresPermission @NonNull Intent intent, int
            requestCode)
    {
            ...
            requestCode, @Nullable Bundle options)
    {
        if (mParent == null)
        {
            ...
            try
            {
                ...
                result = ActivityManagerNative.getDefault().startActivity(mMainThread
                        .getApplicationThread(), getBasePackageName(), intent, intent
                        .resolveTypeIfNeeded(getContentResolver()), mToken, mEmbeddedID,
        ...
        throw new UnsupportedOperationException("startActivityIfNeeded can only be called from a " +
                "top-level activity");
    }
                                             ...
                                             @Nullable Bundle options)
    {
        if (mParent == null)
        {
            try
            {
                intent.migrateExtraStreamToClipData();
                intent.prepareToLeaveProcess(this);
                return ActivityManagerNative.getDefault().startNextMatchingActivity(mToken,
                        intent, options);
            }
            catch (RemoteException e)
            {
        ...
        throw new UnsupportedOperationException("startNextMatchingActivity can only be called " +
                "from a top-level activity");
    }
     ...
     * @see #startActivityForResult
     */
    public void startActivityFromChild(@NonNull Activity child, @RequiresPermission Intent
     ...
     */
    public void startActivityFromChild(@NonNull Activity child, @RequiresPermission Intent
            intent, int requestCode, @Nullable Bundle options)
    {
        options = transferSpringboardActivityOptions(options);
        Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread
                .getApplicationThread(), mToken, child, intent, requestCode, options);
        if (ar != null)
        {
            mMainThread.sendActivityResult(mToken, child.mEmbeddedID, requestCode, ar
                    .getResultCode(), ar.getResultData());
        }
        cancelInputsAndStartExitTransition(options);
    }
     ...
     */
    public void startActivityFromFragment(@NonNull Fragment fragment, @RequiresPermission Intent
            intent, int requestCode)
    {
     ...
     */
    @Override
    public void startActivityForResult(String who, Intent intent, int requestCode, @Nullable
            Bundle options)
    {
        Uri referrer = onProvideReferrer();
        if (referrer != null)
        ...
        options = transferSpringboardActivityOptions(options);
        Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread
                .getApplicationThread(), mToken, who, intent, requestCode, options);
        if (ar != null)
        {
            mMainThread.sendActivityResult(mToken, who, requestCode, ar.getResultCode(), ar
                    .getResultData());
        }
        cancelInputsAndStartExitTransition(options);
    }
    ...
    public void startIntentSenderFromChild(Activity child, IntentSender intent, int requestCode,
                                           Intent fillInIntent, int flagsMask, int flagsValues,
                                           int extraFlags, @Nullable Bundle options) throws
            IntentSender.SendIntentException
    {
     ...
     * @hide
     */
    public void startIntentSenderFromChildFragment(Fragment child, IntentSender intent, int
            requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags,
                                                   @Nullable Bundle options) throws IntentSender
            .SendIntentException
    {
        startIntentSenderForResultInner(intent, child.mWho, requestCode, fillInIntent, flagsMask,
                flagsValues, options);
    }
    ...
    public Uri getReferrer()
    {
        ...
        {
            Log.w(TAG, "Cannot read referrer from intent;" + " intent extras contain unknown " +
                                             ...
                                             @PendingIntent.Flags int flags)
    {
        ...
        try
        {
            ...
            IIntentSender target = ActivityManagerNative.getDefault().getIntentSender
                    (ActivityManager.INTENT_SENDER_ACTIVITY_RESULT, packageName, mParent == null
                            ? mToken : mParent.mToken, mEmbeddedID, requestCode, new
                            Intent[]{data}, null, flags, null, UserHandle.myUserId());
    ...
    public Object getSystemService(@ServiceName @NonNull String name)
    {
        ...
        {
            throw new IllegalStateException("System services not available to Activities before " +
                    "onCreate()");
        }
    ...
    public void setTaskDescription(ActivityManager.TaskDescription taskDescription)
    {
        if (mTaskDescription != taskDescription)
        {
            ...
            if (taskDescription.getIconFilename() == null && taskDescription.getIcon() != null)
            {
                ...
                final Bitmap icon = Bitmap.createScaledBitmap(taskDescription.getIcon(), size,
                        size, true);
    ...
    {
        getWindow().setFeatureInt(Window.FEATURE_PROGRESS, visible ? Window
                .PROGRESS_VISIBILITY_ON : Window.PROGRESS_VISIBILITY_OFF);
    }
    ...
    {
        getWindow().setFeatureInt(Window.FEATURE_INDETERMINATE_PROGRESS, visible ? Window
                .PROGRESS_VISIBILITY_ON : Window.PROGRESS_VISIBILITY_OFF);
    }
    ...
    {
        getWindow().setFeatureInt(Window.FEATURE_PROGRESS, indeterminate ? Window
                .PROGRESS_INDETERMINATE_ON : Window.PROGRESS_INDETERMINATE_OFF);
    }
    ...
    {
        getWindow().setFeatureInt(Window.FEATURE_PROGRESS, secondaryProgress + Window
     ...
     */
    @SystemApi
    public boolean convertToTranslucent(TranslucentConversionListener callback, ActivityOptions
            options)
    {
    ...
    public boolean requestVisibleBehind(boolean visible)
    {
        ...
        try
        {
            mVisibleBehind = ActivityManagerNative.getDefault().requestVisibleBehind(mToken,
                    visible) && visible;
        }
        catch (RemoteException e)
        {
     ...
     *                           {@link android.service.vr.VrListenerService} while VR mode is
     *                           enabled.
     * @throws android.content.pm.PackageManager.NameNotFoundException if the given component
     *                                                                 to run as a
     *                                                                 {@link android.service.vr.VrListenerService} is not installed, or has
     *                                                                 not been enabled in user
     *                                                                 settings.
    ...
    public boolean shouldUpRecreateTask(Intent targetIntent)
    {
        try
        {
            ...
            return ActivityManagerNative.getDefault().shouldUpRecreateTask(mToken, info
                    .taskAffinity);
        }
        catch (RemoteException e)
        {
    ...
    final void attach(Context context, ActivityThread aThread, Instrumentation instr, IBinder
            token, int ident, Application application, Intent intent, ActivityInfo info,
                      CharSequence title, Activity parent, String id, NonConfigurationInstances
                              lastNonConfigurationInstances, Configuration config, String
                              referrer, IVoiceInteractor voiceInteractor, Window window)
    {
        ...
        if (voiceInteractor != null)
        {
            ...
            {
                mVoiceInteractor = new VoiceInteractor(voiceInteractor, this, this, Looper
                        .myLooper());
            }
        }

        mWindow.setWindowManager((WindowManager) context.getSystemService(Context.WINDOW_SERVICE)
                , mToken, mComponent.flattenToString(), (info.flags & ActivityInfo
    ...
    {
        mVisibleFromClient = !mWindow.getWindowStyle().getBoolean(com.android.internal.R
                .styleable.Window_windowNoDisplay, false);
    ...
    final void performStart()
    {
        ...
        boolean isAppDebuggable = (mApplication.getApplicationInfo().flags & ApplicationInfo
                .FLAG_DEBUGGABLE) != 0;
            ...
            synchronized (mManagedCursors)
            {
                ...
                for (int i = 0; i < N; i++)
                {
                    ...
                    if (mc.mReleased || mc.mUpdated)
                    {
                        ...
                        {
                            if (getApplicationInfo().targetSdkVersion >= android.os.Build
                                    .VERSION_CODES.ICE_CREAM_SANDWICH)
                            {
                                throw new IllegalStateException("trying to requery an already " +
                                        "closed cursor  " + mc.mCursor);
                            }
                        }
                        mc.mReleased = false;
                        mc.mUpdated = false;
    ...
    final void performResume()
    {
        ...
        if (!mVisibleFromClient && !mFinished)
        {
            ...
            {
                throw new IllegalStateException("Activity " + mComponent.toShortString() +
    ...
    {
        if (DEBUG_LIFECYCLE)
            Slog.v(TAG, "dispatchMultiWindowModeChanged " + this + ": " + isInMultiWindowMode);
    ...
    {
        if (DEBUG_LIFECYCLE)
            Slog.v(TAG, "dispatchPictureInPictureModeChanged " + this + ": " +
    ...
    private void restoreHasCurrentPermissionRequest(Bundle bundle)
    {
        if (bundle != null)
        {
            mHasCurrentPermissionsRequest = bundle.getBoolean(HAS_CURENT_PERMISSIONS_REQUEST_KEY,
                    false);
        }
    }
    ...
    {
        if (false)
            Log.v(TAG, "Dispatching result: who=" + who + ", reqCode=" + requestCode + ", " +
        ...
        else if (who.startsWith("@android:view:"))
        {
            ...
            {
                if (viewRoot.getView() != null && viewRoot.getView().dispatchActivityResult(who,
    ...
    private void dispatchRequestPermissionsResult(int requestCode, Intent data)
    {
        ...
        String[] permissions = (data != null) ? data.getStringArrayExtra(PackageManager
                .EXTRA_REQUEST_PERMISSIONS_NAMES) : new String[0];
        final int[] grantResults = (data != null) ? data.getIntArrayExtra(PackageManager
                .EXTRA_REQUEST_PERMISSIONS_RESULTS) : new int[0];
    ...
    class HostCallbacks extends FragmentHostCallback<Activity>
    {
        ...
        public void onStartIntentSenderFromFragment(Fragment fragment, IntentSender intent, int requestCode, @Nullable Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException
        {
            ...
            {
                mParent.startIntentSenderFromChildFragment(fragment, intent, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, options);
            }
        }
